...
#where the controlled vocabs live
...
test_one_refresh_for_vocab <- function(arow) {
  ...
  # if you have a refresh function that returns more than the standard
  # cols, use an if statement to snip it off! use | for more than 1
  # refresh function
  # make sure column names are in order
  # if (arow$fun == "refresh_FUN") {
  #   refresh_col_names <-
  #     c(
  #       "date",
  #       "location",
